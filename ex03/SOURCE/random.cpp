...
void Random :: SetSeed(){
	// This function initializes the random number generator by reading the seed values and two prime numbers from external files
   int seed[4];   
   int p1, p2;
...
double Random::Linear(){
	// This function generates a random number from a linear distribution 2*(1-x)
    double y=Rannyu();
    return 1. - sqrt(1.-y);
}
